...
"""
with open(os.path.join(root_dir, "addons.xml"), "w", encoding="utf-8") as f:
    f.write(addons_xml)
...
# === 6. Zip the Dropbox.downloader add-on ===
zip_filename = os.path.join(zips_dir, f"{ADDON_ID}-{VERSION}.zip")
...
print(f"📦 Addon ZIP: {zip_filename}")
print(f"📦 Repo ZIP: {repo_zip_path}")
